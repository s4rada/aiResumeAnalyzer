...
export const meta = () => {[
    ...
    {name: 'description', content: 'Detailed oveview of your resume'}
]}
const Resume = () => {
    ...
    <main className='!pt-0' >
        ...
        <div className='flex flex-row w-full max-lg:flex-col-reverse'>
            ...
            <section className='feedback-section bg-[url("/images/bg-small.svg")] bg-cover h-[100vh] sticky top-0 items-center justify-center w-full'>
                {imageUrl && resumeUrl && (
                    <div className='animate-in fade-in duration-1000 gradient-border max-sm:m-0[90%] h-[90%] max-wxl:h-fit w-fit'>
                    <a href={resumeUrl} target="_blank" rel='noopenner noreferrer'>
